...
- Daten aktuell bis: **20.09.2026**
- Zeitraum: **3Y** (20.09.2023 → 20.09.2026)
- Berichtswährung: **USD** · Benchmark: **SP500**
- Instrumente: **7** · Märkte: **32** · Währungen: **20**

## Kommentar

Im gewählten Zeitraum (20.09.2023 → 20.09.2026, umgerechnet in USD) führt **SPY** mit einer CAGR von 21.7%, während **FUEVFVND** mit 5.0% das Schlusslicht bildet. 1 von 7 Instrumenten schlagen die Benchmark **SP500** (20.3%). Die beste risikoadjustierte Rendite liefert **SPY** (Sharpe 1.42); den tiefsten Drawdown trägt **VNM** mit -28.4%. Die durchschnittliche Korrelation der Auswahl liegt bei 0.40 — das reicht für einen spürbaren Diversifikationseffekt.
