...
- Data updated to: **29.08.2026**
- Time range: **3Y** (29.08.2023 → 29.08.2026)
- Reporting currency: **USD** · Benchmark: **VNINDEX**
- Instruments: **6** · Markets: **32** · Currencies: **20**

## 🤖 Automated commentary

Over the selected window (29.08.2023 → 29.08.2026, converted to USD), **SPY** leads with a CAGR of 21.2%, while **FUEVFVND** trails at 7.0%. 3 of 6 instruments beat the **VNINDEX** benchmark (12.0%). The best risk-adjusted result belongs to **EUNL.DE** (Sharpe 1.41), and **VNM** carries the deepest drawdown at -31.6%. Average pairwise correlation is 0.41, enough for a real diversification benefit.
