...
Over the selected window (19.09.2023 → 19.09.2026, converted to USD), **SPY** leads with a CAGR of 21.1%, while **FUEVFVND** trails at 7.2%. 2 of 7 instruments beat the **SP500** benchmark (19.9%). The best risk-adjusted result belongs to **EUNL.DE** (Sharpe 1.38), and **VNM** carries the deepest drawdown at -28.4%. Average pairwise correlation is 0.39, enough for a real diversification benefit.
